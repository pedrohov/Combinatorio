...
Matrix  matSolucaoPivotLU(Matrix upper, Matrix lower, Matrix P, Matrix b);       // Retorna uma matriz (1 x n) com a solucao do sistema (mat, b). Matriz b(n, 1).
Matrix 	matSubstSucessiva (Matrix lower, Matrix b);             // Retorna uma matriz (1 x n) com a solucao do sistema (lower, b) (Usado por SolucaoPivotLU).
